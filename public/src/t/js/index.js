...
$(function(){
    ...
    __GetIP();
    __GetInfo();
    console.log("%c🌳 Name：NguyenThai | Bio：Sayy Hello | Url：https://www.nguyenthai.com 🌳", "font-family: ;color:#fff; background: linear-gradient(270deg, #18d7d3, #68b7dd, #8695e6, #986fee); padding: 8px 15px; border-radius: 8px");
    console.log("…………./´¯/)……….. (\\¯’\\\n…………/….//……….. …\\\\….\\\n………../….//………… ….\\\\….\\\n…../´¯/…./´¯\\\\………../¯‘\\\\…./¯’\\\\\n.././…/…./…./.|_|……_| .\\\\…\\\\…\\\\…\\\\.\\\\\n(.(….(….(…./.)..)..(..(. \\\\….)….)….).)\n.\\\\…………….\\/…/…\\\\. ..\\/……………./\n..\\\\…………….. /……..\\\\………………../\n…\\\\…………..(………. ..)……………./");
  });
// CHECK FPS
...
function ShowToast() {
  ...
  $(document).ready(function() {
    ...
    $('#Facebook').click(function() {
        OpenUrl('https://www.facebook.com/profile.php?id=100073107057990');
    });
      // SET URL YOUTUBE
    $('#Youtube').click(function() {
        OpenUrl('https://www.youtube.com/@baihocmoingay-7');
    });
    // SET URL TIKTOK
    $('#Tiktok').click(function() {
        OpenUrl('https://www.tiktok.com/@anhthaidz20?_t=ZS-8wEyxw8YkpG&_r=1');
    });
      // SET URL LOCKET
    $('#Locket').click(function() {
        OpenUrl('https://locket.camera/links/aragj7SUx21GuzBC8');
    });
  });
